...
INLINE_KEYBOARD = [
    [
        {
            "text": "NUMBER CHANNEL",
            "url": "https://t.me/auroratechinc"
        },
        {
            "text": "BACKUP CHANNEL",
            "url": "https://t.me/mrafrixtech"
        }
    ],
    [
        {
            "text": "OTP GROUP",
            "url": "https://t.me/afrixotpgc"
        },
        {
            "text": "CONTACT OWNER",
...
def send_telegram(text: str):  
    ...
    for cid in CHAT_IDS:
        # Send as photo with caption so banner is always shown
        requests.post(
            url,
            data={
                "chat_id": cid,
...
def make_reply_markup():
    import json
    # Telegram expects an inline_keyboard JSON string for reply_markup
